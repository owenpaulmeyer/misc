...
instance Show Value where
	show (I i) = show i
	show (L v) = show v
	show (Cl (f, e)) = "Cl ("++show f++ show e  -- ",env)"
	show (B b) = show b
	show (E env) = show env
...
t7 = [fac, LET, CLOS, ENDLET, LET, NIL, LDC (I 1), CONS, LDC (I 3), CONS, APP, LDC (I 9)]
fac = BL [ACC 2, LDC (I 0), Rel Equ, SEL,
	BL [ACC 2],
	BL [ACC 1, ACC 2, Op Mul, LDC (I 1), ACC 1, Op Sub, ENDLET, ENDLET, LET, LET, ACC 3, CLOS, ENDLET, ENDLET, ENDLET, APP ]]
