...
lesy = (Lam "f" (Lam "a" (Lam "as" (App (App (App isEmpty (Var "as")) empty) (App (App (App iF (App (App lte (App hd (Var "as"))) (Var "a"))) (App (App cons (App hd (Var "as"))) (App (App (Var "f") (Var "a")) (App tl (Var "as"))))) (App (App (Var "f") (Var "a")) (App tl (Var "as"))))))))
...
pqlist = (App (App pr five) (App (App pr three) (App (App pr four) (App (App pr two) (App (App pr one) (App (App pr zero) (App (App pr three) (App (App pr four) (App (App pr one) (App (App pr five) (App (App pr zero) (App (App pr two) nil))))))))))))
...
mane = (App (App insort pqlist) (App (App insort pqlist) nil))
