...
public class EditElement {
        ...
        EditElement ( DynamicTree dt, ChildrenList cL, ConnectionsList cnL, Grid g, Child seed ){
...
//           recPaint(g,p);
            if ( c.element().isEmpty()) {
                ...
                for ( Child child : c.children()){
                    paintEmpties( g, child.locateToPaint(c.location()));
                }
            }
        }
        ...
        public void saveTree(){
            save = dynamicTree.root();
        }
        public void loadTree(){
            dynamicTree.setRoot(save);
            selected = dynamicTree.root();
        }
    }
