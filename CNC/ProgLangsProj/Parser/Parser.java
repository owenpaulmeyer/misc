...
public class Parser {
    ...
    private void declaration (Declarations ds) {
		...
		ds.add(new Declaration((Variable)v,t));
		while(isComma()){
			match(TokenType.Comma);
			Expression v2 = primary();
			//System.out.println("found Declrtn: "+v2.toString());
			ds.add(new Declaration((Variable)v2,t));
		}
    ...
    private Assignment assignment () {
		...
		match(TokenType.Semicolon);
        return new Assignment((Variable)targ,source);  // student exercise
    }
