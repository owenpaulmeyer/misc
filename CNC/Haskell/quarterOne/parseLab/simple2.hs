...
--S -> Aabd | cAbcd
--A -> a | b | lambda
--if lookahead fails, then the next do block tries;
--if lookahead succeeds then the rest of the first do block continues;
--if the rest of this do block fails then the next do block tries.
