...
lp = do {l <- symb "("; return Lp}
rp = do {r <- symb ")"; return Rp}

exps = do {e <- expr; return e} +++ do {return Eps}
------------------------------------------------
--Data Structure for expressions


data Expr = Lp Expr Rp Expr| Eps --deriving Show
data Rp = Rp --deriving Show

instance Show Expr where
	show (Lp e Rp e') = "("++show e++")"++show e'
	show Eps = ""
