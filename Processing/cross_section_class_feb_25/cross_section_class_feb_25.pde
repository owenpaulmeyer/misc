...
cross_section[] cross_sections_array = new cross_section[ 0 ];
...
void draw() {
  ...
  cross_sections_array = append( cross_sections_array, holder );
  //section_edges = append( section_edges, seg_intersection[ 2 ] );
  ...
  for( int idx = 0; idx < oncemore.length -1; idx += 3 ) {
