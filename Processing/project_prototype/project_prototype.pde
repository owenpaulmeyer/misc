 ...
 float[][] points_for_edge ( int edge ) {   //inputs an edge number to retrieve coordinates
   ...
   void rotation( float theta, float x_r, float y_r, String axis ){
    ...
    for( int point_idx = 0; point_idx < 8; point_idx ++){
      float pass_x = ( points_coordinates[ point_idx ][ a ] * cos( theta ) ) + ( points_coordinates[ point_idx ][ b ] * -sin( theta ) ) + ( x_r * ( 1 - cos( theta ) ) + y_r * sin( theta ) );
      float pass_y = ( points_coordinates[ point_idx ][ a ] * sin( theta ) ) + ( points_coordinates[ point_idx ][ b ] *  cos( theta ) ) + ( y_r * ( 1 - cos( theta ) ) - x_r * sin( theta ) );
...
// debug:
 ...
 block cube_1 = new block( 120, 120, 120, 0, 0, 0 );;
...
//
//   point( cube_1.points_coordinates[ idx ][ 0 ],
//     cube_1.points_coordinates[ idx ][ 1 ],
//     cube_1.points_coordinates[ idx ][ 2 ] );
//   }
...
//  cube_1.rotation( radians( 1 ), 0, 0, "z" );
  ...
  camera(mouseX, mouseY, 220.0, // eyeX, eyeY, eyeZ
   ...
   strokeWeight( 1 );
   beginShape();   
   vertex( cube_1.points_coordinates[ 0 ][ 0 ], cube_1.points_coordinates[ 0 ][ 1 ], cube_1.points_coordinates[ 0 ][ 2 ] );
   vertex( cube_1.points_coordinates[ 1 ][ 0 ], cube_1.points_coordinates[ 1 ][ 1 ], cube_1.points_coordinates[ 1 ][ 2 ] );
   vertex( cube_1.points_coordinates[ 5 ][ 0 ], cube_1.points_coordinates[ 5 ][ 1 ], cube_1.points_coordinates[ 5 ][ 2 ] );
   vertex( cube_1.points_coordinates[ 4 ][ 0 ], cube_1.points_coordinates[ 4 ][ 1 ], cube_1.points_coordinates[ 4 ][ 2 ] );
   endShape(CLOSE);
...
//   fill( 95, 250, 93, 205 );
   ...
   vertex( cube_1.points_coordinates[ 5 ][ 0 ], cube_1.points_coordinates[ 5 ][ 1 ], cube_1.points_coordinates[ 5 ][ 2 ] );
   vertex( cube_1.points_coordinates[ 1 ][ 0 ], cube_1.points_coordinates[ 1 ][ 1 ], cube_1.points_coordinates[ 1 ][ 2 ] );
   vertex( cube_1.points_coordinates[ 2 ][ 0 ], cube_1.points_coordinates[ 2 ][ 1 ], cube_1.points_coordinates[ 2 ][ 2 ] );
   vertex( cube_1.points_coordinates[ 6 ][ 0 ], cube_1.points_coordinates[ 6 ][ 1 ], cube_1.points_coordinates[ 6 ][ 2 ] );
   endShape(CLOSE);
...
//   fill( 239, 250, 93, 205 );
   ...
   vertex( cube_1.points_coordinates[ 5 ][ 0 ], cube_1.points_coordinates[ 5 ][ 1 ], cube_1.points_coordinates[ 5 ][ 2 ] );
   vertex( cube_1.points_coordinates[ 6 ][ 0 ], cube_1.points_coordinates[ 6 ][ 1 ], cube_1.points_coordinates[ 6 ][ 2 ] );
   vertex( cube_1.points_coordinates[ 7 ][ 0 ], cube_1.points_coordinates[ 7 ][ 1 ], cube_1.points_coordinates[ 7 ][ 2 ] );
   vertex( cube_1.points_coordinates[ 4 ][ 0 ], cube_1.points_coordinates[ 4 ][ 1 ], cube_1.points_coordinates[ 4 ][ 2 ] );
   endShape(CLOSE);
...
//   fill( 250, 198, 93, 205 );
   ...
   beginShape();
   vertex( cube_1.points_coordinates[ 2 ][ 0 ], cube_1.points_coordinates[ 2 ][ 1 ], cube_1.points_coordinates[ 2 ][ 2 ] );
   vertex( cube_1.points_coordinates[ 3 ][ 0 ], cube_1.points_coordinates[ 3 ][ 1 ], cube_1.points_coordinates[ 3 ][ 2 ] );
   vertex( cube_1.points_coordinates[ 7 ][ 0 ], cube_1.points_coordinates[ 7 ][ 1 ], cube_1.points_coordinates[ 7 ][ 2 ] );
   vertex( cube_1.points_coordinates[ 6 ][ 0 ], cube_1.points_coordinates[ 6 ][ 1 ], cube_1.points_coordinates[ 6 ][ 2 ] );
   endShape(CLOSE);
...
//   fill( 197, 93, 250, 205 );
   ...
   for( int idx = 0; idx < oncemore.length; idx += 6 ){
     ...
     vertex( oncemore[ idx+3 ], oncemore[ idx+4 ], oncemore[ idx+5 ] );
     endShape();
   }
//   strokeWeight(6);
//    for ( int idx = 0; idx < 8; idx ++ ){
