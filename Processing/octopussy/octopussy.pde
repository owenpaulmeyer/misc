  ...
  //the x term(axis)of the function is used as "time" as the complex term is not constrainable
    ...
    for(int angle = 0;angle < 361; angle += 3) {
     ...
     // complex = -y*y*y + 3*x*x*y;
      ...
      holder[xCount][(angle/3)][3] = z*.01;
      ;//x here in place of the complex term will give the "saddle shape"
